<template>
  <div class="page-container page-content">
    ...
    <div class="page-header">
          ...
          <div class="p-5">
            <div class="flex items-center">
              ...
              <div class="ml-5 w-0 flex-1">
                <dl>
                  <dt class="text-sm font-medium text-gray-500 truncate">Total CIs</dt>
                  <dd class="text-lg font-medium text-gray-900">{{ stats.totalCIs }}</dd>
                </dl>
              </div>
            </div>
          </div>
            ...
            <div class="flex items-center">
              ...
              <div class="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd class="text-lg font-medium text-gray-900">{{ stats.totalCITypes }}</dd>
                </dl>
              </div>
            </div>
          </div>
            ...
            <div class="flex items-center">
              ...
              <div class="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd class="text-lg font-medium text-gray-900">{{ stats.totalRelationships }}</dd>
                </dl>
              </div>
            </div>
          </div>
      ...
      <!-- Quick actions -->
      <div v-if="hasCreatePermissions" class="bg-white shadow rounded-lg mb-8">
      ...
      <div class="bg-white shadow rounded-lg">
        <div class="px-4 py-5 sm:p-6">
          ...
          <div class="space-y-4">
            ...
            <div v-else v-for="activity in recentActivity" :key="activity.id" class="flex items-center space-x-3">
              <div class="flex-shrink-0">
...
const loadDashboardData = async () => {
  try {
    ...
    stats.value = {
      totalCIs: response.data.total_cis,
      totalCITypes: response.data.total_ci_types,
      totalRelationships: response.data.total_relationships,
      totalUsers: response.data.total_users,
    }

    // Load recent activity would go here
  } catch (error) {
